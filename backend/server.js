...
// This fixes the 404 error - these routes match what your frontend expects
...
// ============= EXISTING ROUTES (With /api prefix) =============
// Routes
const authRoutes = require('./routes/authRoutes');
const healthRoutes = require('./routes/healthRoutes');
  ...
  res.json({ 
    ...
    endpoints: {
      ...
      api: {
        ...
        healthData: 'GET/POST /api/health-data'
      }
    }
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`🎯 API endpoints: /api/ai-suggestions, /api/health-data`);
});